...
toggleBtn.addEventListener('click', () => {
    if (!isMenuActive) {
        ...
        // menuItems[0].style.transform = 'translate(0, 0)'
        // menuItems[1].style.transform = 'translate(0, 0)'
        // menuItems[2].style.transform = 'translate(0, 0)'
        // menuItems[3].style.transform = 'translate(0, 0)'
